        ...
        <section className="flex justify-center items-center h-screen box-border">
            ...
            <div className="w-2/3 shadow-2xl py-10 md:w-1/3">
                ...
                <div className="flex justify-evenly">
                    ...
                    <button className="bg-blue-500 py-2 px-4 rounded-2xl">Login</button>
                </div>
                <div>
                    <button className="text-green-400 font-light font-sans mt-14 ml-14 font-medium">Belum punya toko?</button>
                </div>
            </div>
        </section>
    );
